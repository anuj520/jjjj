...
const getlocal = (hexValue)=>{
return  JSON.parse( localStorage.getItem("anuj"));
}
const getlocal2 = (hexValue)=>{
return  JSON.parse( localStorage.getItem("anuj2"));
}

rgbcolor = getlocal(hexValue)||[];
rgbcolor2 = getlocal2(hexValue)||[];
...
const handele1 = ()=>{
    ...
    btn1.style.background = `linear-gradient(to right,${rgb1},${rgb1})`;
    local = localStorage.setItem("anuj",JSON.stringify(rgb1));
...
const handele2 = ()=>{
    ...
    btn2.style.background = `linear-gradient(to right,${rgb2},${rgb2})`;
    local = localStorage.setItem("anuj2",JSON.stringify(rgb2));
}
const handele3 = ()=>{
    localStorage.removeItem("anuj");
    localStorage.removeItem("anuj2");
    alert("Please Refresh Color Change");
}
const showTodoList = ()=>{
console.log(rgbcolor);
document.body.style.backgroundImage = `linear-gradient(to right,${rgbcolor},${rgbcolor2})`;
btn1.style.background = `linear-gradient(to right,${rgbcolor},${rgbcolor2})`;
...
document.body.style.backgroundImage = `linear-gradient(to right,${rgbcolor},${rgbcolor2}`;
btn2.style.background = `linear-gradient(to right,${rgbcolor},${rgbcolor2})`;
}
...
btn2.addEventListener("click",()=>{
    localStorage.setItem("anuj2",JSON.stringify(rgb2));
handele2();
});

btn1.addEventListener("click",()=>{
localStorage.setItem("anuj",JSON.stringify(rgb1));
handele1();
});

btn3.addEventListener("click",handele3);
...
const mainAytem = document.querySelector("#main-aytem");
...
const megaProject = ()=>{
 ...
 const megaProject2 = ()=>{
    ...
    nv2.style.visibility = "visible"
    number.style. visibility = "visible"
    mainAytem.style.display = "block"
    mainAytem.style.display = "flex"
